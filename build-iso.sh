...
for item in components hypr kitty scripts starship install.sh shell.qml COMANDOS.txt DEPENDENCIAS.md dependencies.txt wallpapers themes viewers fastfetch; do
