...
for item in bin components hypr kitty scripts starship install.sh shell.qml COMANDOS.txt GUIA_TEMAS.md DEPENDENCIAS.md dependencies.txt wallpapers themes viewers fastfetch assets desktop; do
