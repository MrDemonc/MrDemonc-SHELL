...
ln -sf "$REPO_DIR/shell.qml" "$USER_HOME/.config/quickshell/shell.qml"
ln -sfn "$REPO_DIR/components" "$USER_HOME/.config/quickshell/components"
ln -sfn "$REPO_DIR/scripts" "$USER_HOME/.config/quickshell/scripts"
ln -sfn "$REPO_DIR/assets" "$USER_HOME/.config/quickshell/assets"
ln -sfn "$REPO_DIR/bin" "$USER_HOME/.config/quickshell/bin"
