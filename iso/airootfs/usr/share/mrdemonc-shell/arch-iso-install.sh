...
WRAP_CAFFEINE
    ...
    cat << WRAP_RECORDER > "$USER_HOME/.local/bin/shell-recorder"
#!/usr/bin/env bash
exec /home/$SYS_USER/Documentos/MrDemonc-SHELL/bin/shell-recorder "\$@"
WRAP_RECORDER

    cat << WRAP_COLORPICKER > "$USER_HOME/.local/bin/shell-colorpicker"
#!/usr/bin/env bash
exec /home/$SYS_USER/Documentos/MrDemonc-SHELL/bin/shell-colorpicker "\$@"
WRAP_COLORPICKER

    cat << WRAP_LOCK > "$USER_HOME/.local/bin/shell-lock"
#!/usr/bin/env bash
exec /home/$SYS_USER/Documentos/MrDemonc-SHELL/bin/shell-lock "\$@"
WRAP_LOCK
