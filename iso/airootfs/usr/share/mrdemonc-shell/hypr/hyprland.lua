...
-- Cargar diseño, bordes rectos y colores adaptativos desde ~/.config/hypr/windows.lua
require("windows")
...
-- Cargar atajos desde archivo dedicado: ~/.config/hypr/keybinds.lua
require("keybinds")
...
-- Minimalist Viewers (Image, Video, PDF) and Screenshot Tool
hl.window_rule({
    name  = "shell-viewers-and-tools",
    match = { title = "^.*(Visor de Imágenes|Reproductor de Video|Visor de PDF|Captura de Pantalla).*$" },
    float = true,
    center = true,
})
